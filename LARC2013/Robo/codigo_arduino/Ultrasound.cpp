...
{
	sonar[0] = NewPing(US_TRIG_1, US_ECHO_1, MAX_DISTANCE);
	sonar[1] = NewPing(US_TRIG_2, US_ECHO_2, MAX_DISTANCE);	
	sonar[2] = NewPing(US_TRIG_3, US_ECHO_3, MAX_DISTANCE);
	sonar[3] = NewPing(US_TRIG_4, US_ECHO_4, MAX_DISTANCE);	
	sonar[4] = NewPing(US_TRIG_5, US_ECHO_5, MAX_DISTANCE);
	sonar[5] = NewPing(US_TRIG_6, US_ECHO_6, MAX_DISTANCE);	
