...
public class ErusView extends View
{
	...
	public void setUltraSound(int data1, int data2, int data3)
	{
		us1 = data1;
		us2 = data2;
		us3 = data3;
	...
	public void onDraw(Canvas canvas) 
	{
		...
		if(connectedAndroid)
			canvas.drawText("Android Connected", 4, 200, greenPaint);
		else
			canvas.drawText("Android NOT Connected", 4, 200, redPaint);
		
		canvas.drawText("Encoder: "+encRight+ " " + encLeft, 4, 250, redPaint);
		
		canvas.drawText("Ultrasound: "+us1+ " " + us2+ " " + us3, 4, 300, redPaint);
