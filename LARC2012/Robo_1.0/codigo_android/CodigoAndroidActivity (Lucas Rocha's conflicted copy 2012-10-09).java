    ...
    */
    ...
    {    	
    	if(connectToArduino)
		{
    		...
    		while(connectionArduino == null)	// For the arduino, keep waiting forever for the connection to work
    		{
	...
	{ 			
		...
		{ 			
			...
			robotBrain.process(mAccelerometer, mCompass, mEncoder, mUltraSound,mClawButton, cameraProcessor);
