...
public class Fiscal extends JFrame implements KeyListener, MouseListener, Runnable
{
	...
	private final byte forward[] = {0x14,(byte) 0xFF,0,(byte) 0xFF,1};
	private final byte backward[] = {0x14,(byte) 0xFF,1,(byte) 0xFF,0};
	private final byte right[] = {0x14,(byte) 0xFF,0,(byte) 0x80,1};
	private final byte left[] = {0x14,(byte) 0x80,1,(byte) 0xFF,0};
	
	
	private final byte stop1[] = {0x10,0,0};
	private final byte stop2[] = {0x11,0,0};
	private final byte reqImg[] = {0x61};
	private final byte reqImgBack[] = {0x68};
	...
	private void sendRequestReceiveImage()
	{
		try {
	...
	private void sendRequestReceiveImageBack()
	{
		try {
			connection.sendMessage(reqImgBack, 0, 1);
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
